...
#
# $ python3 task02_terminal.py 42 3.14 73
# python argparse01.py --help
#
...
# python argparse01.py Hello World!!

# Запуск с неверными аргументами
# При попытке передать в скрипт Hello world! получим:
# usage: task02_terminal.py [-h] [N ...]
# task02_terminal.py: error: argument N: invalid float value: 'Hello'
