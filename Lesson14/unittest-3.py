...
class TestPrime(unittest.TestCase):
    ...
    def test_warning_false(self, mock_stdout):
        ...
        self.assertEqual(mock_stdout.getvalue(), 'If the number P is prime, the check may take a '
                                                 'long time. Working...\n')

    @patch('sys.stdout', new_callable=io.StringIO)
    def test_warning_true(self, mock_stdout):
        self.assertTrue(is_prime(100_000_007))
        self.assertEqual(mock_stdout.getvalue(), 'If the number P is prime, the check may take'
                                                 ' a long time. Working...\n')
